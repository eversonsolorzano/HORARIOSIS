...
// Aplicar filtros
if ($dia && in_array($dia, ['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'])) {
...
$sql .= " GROUP BY h.id_horario ORDER BY FIELD(h.dia_semana, 'Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado'), h.hora_inicio";
...
$stmt = $db->prepare("
    SELECT DISTINCT s.id_semestre, s.codigo_semestre, s.nombre_semestre
    FROM horarios h
    JOIN semestres_academicos s ON h.id_semestre = s.id_semestre
    WHERE h.id_profesor = ? AND h.activo = 1
...
// MODIFICACIÓN: Horas del día (de 8:00 AM a 2:00 PM en intervalos de 30 minutos)
$horas_dia = [];
...
foreach ($horarios as $horario) {
    ...
    $horarios_organizados[$dia][] = [
        ...
        'estudiantes' => $horario['estudiantes_inscritos'],
...
$total_horas_semanales = array_sum(array_column($horarios, 'horas_semanales'));
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Mis Horarios - Sistema de Horarios</title>
    ...
    <style>
        ...
        /* Estilo para horas fuera del horario laboral */
    ...
    <div class="container">
        <div class="header">
            <div>
                ...
                <div class="nav">
                    ...
                    <a href="mis_horarios.php" class="active"><i class="fas fa-calendar-alt"></i> Mis Horarios</a>
        ...
        <div class="estadisticas-horario">
            <div class="estadistica-card">
                ...
                <div class="estadistica-info">
                    ...
                    <div class="estadistica-numero"><?php echo $total_horas_semanales; ?></div>
                </div>
            </div>
            ...
            <div class="estadistica-card">
                ...
                <div class="estadistica-info">
                    ...
                    <div class="estadistica-numero"><?php echo $total_horarios; ?></div>
                </div>
            </div>
            ...
            <div class="estadistica-card">
                ...
                <div class="estadistica-info">
                    ...
                    <div class="estadistica-numero"><?php echo $total_estudiantes; ?></div>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            ...
            <form method="GET" class="filters-container">
                <div class="filter-group">
                    ...
                    <select name="dia" class="form-control" style="width: 200px;">
                        ...
                        <?php foreach ($dias_semana as $dia_option): ?>
                            <option value="<?php echo $dia_option; ?>" <?php echo $dia == $dia_option ? 'selected' : ''; ?>>
                                <?php echo $dia_option; ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                ...
                <div class="filter-group">
                    <label class="filter-label">Semestre Académico</label>
                    <select name="semestre" class="form-control" style="width: 250px;">
                        <option value="0">Todos los semestres</option>
                        <?php foreach ($semestres as $sem): ?>
                            <option value="<?php echo $sem['id_semestre']; ?>" <?php echo $semestre == $sem['id_semestre'] ? 'selected' : ''; ?>>
                                <?php echo htmlspecialchars($sem['nombre_semestre']); ?> (<?php echo $sem['codigo_semestre']; ?>)
                            </option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="filter-group">
                    <label class="filter-label">Programa de Estudio</label>
                    <select name="programa" class="form-control" style="width: 200px;">
                ...
                <div class="filter-group">
                    ...
                    <a href="mis_horarios.php" class="btn btn-secondary">
        ...
        <div class="card">
            ...
            <?php if (count($horarios) > 0): ?>
                ...
                <div class="horario-grid">
                    ...
                    <?php foreach ($horas_dia as $index => $hora): ?>
                        ...
                        // Determinar si está en horario laboral (8:00 AM - 2:00 PM)
                        ...
                        <?php foreach ($dias_semana as $dia): ?>
                            <div class="celda-clase" id="celda-<?php echo strtolower($dia); ?>-<?php echo str_replace(':', '', $hora_actual); ?>">
                                ...
                                <?php if ($clase_encontrada): ?>
                                    ...
                                    // Verificar si la clase está fuera del horario laboral
                                    ...
                                    <div class="clase-bloque <?php echo $clase_fuera_horario ? 'fuera-horario' : ''; ?>" 
                                        ...
                                        <div class="clase-detalle">
                                            <i class="fas fa-users"></i> <?php echo $clase_encontrada['estudiantes']; ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                            </div>
            ...
            <?php else: ?>
                <div class="empty-state">
                    ...
                    <p>No hay horarios disponibles con los filtros aplicados.</p>
                    <?php if ($dia || $semestre > 0 || $programa > 0): ?>
                        <a href="mis_horarios.php" class="btn btn-primary mt-3">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        ...
                                        <div>
                                            ...
                                            <small><?php echo $h['codigo_curso']; ?> - <?php echo $h['creditos']; ?> créditos</small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <?php echo htmlspecialchars($h['codigo_semestre']); ?><br>
                                    <small><?php echo htmlspecialchars($h['nombre_semestre']); ?></small>
                                </td>
                                <td>
                                    <span class="badge <?php echo $h['estudiantes_inscritos'] > 0 ? 'badge-success' : 'badge-secondary'; ?>">
                                        <?php echo $h['estudiantes_inscritos']; ?> inscritos
                                    </span>
                                </td>
                            </tr>
                            <?php endforeach; ?>
        ...
        function mostrarDetallesClase(elemento) {
            ...
            const html = `
                ...
                <div class="grid-2">
                    ...
                    <div class="modal-info-item">
                        <div class="modal-info-label">Semestre</div>
                        <div class="modal-info-value">${datos.semestre}</div>
                    </div>
                </div>
                
                <div class="modal-info-item">
                    <div class="modal-info-label">Estudiantes Inscritos</div>
                    <div class="modal-info-value">
                        <i class="fas fa-users"></i> ${datos.estudiantes} estudiantes
                    </div>
                </div>
            `;
